...
<main>
    ...
    <?php if (!empty($banner)): ?>
        <section class="banner">
            ...
            <div class="banner-container container py-120">
    ...
    <?php if ($customers): ?>
        <section class="pt-80 pb-40">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-xl-6 d-flex flex-column justify-content-center pt-20 pb-20">
        ...
        <section class="pt-40 pb-40">
            <div class="container">
                <div class="row flex-wrap-reverse">
                    ...
                    <div class="col-12 col-xl-6 d-flex flex-column pt-20 pb-20 justify-content-center">
    ...
    <?php if ($posts->have_posts() ): ?>
        <section class="py-40">
            <div class="container">
                <div class="row swiper-blog swiper">
                    ...
                    <div class="swiper-wrapper">
                        <?php while ($posts->have_posts() ): $posts->the_post(); ?>
                            <article class="swiper-slide pt-20 pb-20">
